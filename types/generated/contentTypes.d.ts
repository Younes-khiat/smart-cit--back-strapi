...
export interface ApiAubergeAuberge extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    capacite_totale: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    chambres_disponibles: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    nombre_chambres: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    tourism_stats: Schema.Attribute.Relation<
      'oneToMany',
      'api::tourism-stat.tourism-stat'
    >;
    type: Schema.Attribute.Enumeration<['maison', 'camping']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'maison'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    role: Schema.Attribute.Enumeration<
      ['tourist', 'admin', 'manager', 'tourism-agency', 'tourist-club']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'tourist'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiComplexTouristiqueComplexTouristique
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::complex-touristique.complex-touristique'
    > &
      Schema.Attribute.Private;
...
export interface ApiLieuTouristiqueLieuTouristique
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adresse: Schema.Attribute.Text & Schema.Attribute.Required;
    closing_hours: Schema.Attribute.Time;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::lieu-touristique.lieu-touristique'
    > &
      Schema.Attribute.Private;
    longitude: Schema.Attribute.String & Schema.Attribute.Required;
    nom: Schema.Attribute.String & Schema.Attribute.Required;
    opening_hours: Schema.Attribute.Time;
    publishedAt: Schema.Attribute.DateTime;
    tourism_stats: Schema.Attribute.Relation<
      'oneToMany',
      'api::tourism-stat.tourism-stat'
    ...
    type: Schema.Attribute.Enumeration<
      ['historique', 'naturel', 'culturel', 'recreatif']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'fine'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTourismStatTourismStat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    hotel: Schema.Attribute.Relation<
      'manyToOne',
      'api::complex-touristique.complex-touristique'
    >;
    lieu_touristique: Schema.Attribute.Relation<
      'manyToOne',
      'api::lieu-touristique.lieu-touristique'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    total_revenue: Schema.Attribute.Integer;
    total_visitors: Schema.Attribute.Integer;
...
export interface ApiTransportTransport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    capacite: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
    ...
    tourism_stats: Schema.Attribute.Relation<
      ...
      'api::tourism-stat.tourism-stat'
    >;
    type: Schema.Attribute.Enumeration<['bus', 'train', 'taxi', 'car_rental']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::complex-touristique.complex-touristique': ApiComplexTouristiqueComplexTouristique;
      'api::event.event': ApiEventEvent;
      'api::lieu-touristique.lieu-touristique': ApiLieuTouristiqueLieuTouristique;
      'api::review.review': ApiReviewReview;
      'api::tourism-stat.tourism-stat': ApiTourismStatTourismStat;
